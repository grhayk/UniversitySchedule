...
namespace Domain.Migrations
{
    ...
    [Migration("20260223183154_AddBuildingAndStructureClassroom")]
    partial class AddBuildingAndStructureClassroom
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Flow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.FlowGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FlowId", "GroupId")
                        .IsUnique();

                    b.ToTable("FlowGroups");
                });
            ...
            modelBuilder.Entity("Domain.Entities.GroupSubjectWithLecturer", b =>
                {
                    ...
                    b.HasIndex("LecturerSubjectId", "FlowId", "LessonType")
                        .IsUnique()
                        .HasFilter("[FlowId] IS NOT NULL");

                    b.HasIndex("LecturerSubjectId", "GroupId", "LessonType")
                        .IsUnique()
                        .HasFilter("[GroupId] IS NOT NULL");

                    b.ToTable("GroupSubjectsWithLecturer", t =>
                        {
                            t.HasCheckConstraint("CK_GroupSubjectWithLecturer_GroupOrFlow", "([GroupId] IS NOT NULL AND [FlowId] IS NULL) OR ([GroupId] IS NULL AND [FlowId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.SubjectClassroom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.SubjectConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.FlowGroup", b =>
                {
                    b.HasOne("Domain.Entities.Flow", "Flow")
                        .WithMany("FlowGroups")
